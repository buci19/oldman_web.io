...
<template>
    <div class="body">
        <div class="header">
            <router-link :to="{ path: '/oldman/Healthyguide' }">
                <div class="return">
                    <img src="@/assets/images/return.png" alt="">
                    <div title="返回健康指导">返回</div>
                </div>
            </router-link>
            <h1>八段锦教学</h1>
        </div>
        <div class="content">
            <div class=" content-video">
                <video class="video" src="@/assets/videos/Healthy8baduanjin.mp4" controls></video>
            </div>
            <div class="content-text">
                <div class="Ctext-header">简介</div>
                <div class="Ctext-title">
                    八段锦的好处
                </div>
                <div class="Ctext-content">
                    <br>1、增加柔韧性：八段锦是一种古老的健身功法，包含了八个小组动作，涵盖身体的各个部位，可以锻炼身体。八段锦中的许多动作都需要进行旋转、舒展和伸展，有助于提高身体的柔韧性。这些动作还可以放松肌肉、加强关节，并增强身体的协调性和平衡能力。
                    <br><br>2、消除疲劳：做八段锦可以增强身体的耐力，并且消除身体和精神上的疲劳。
                    <br><br>3、改善心理健康：八段锦的节奏缓慢而平稳，可以帮助人群放松身心、舒缓压力，缓解焦虑、抑郁等情绪问题。
                    <br><br>4、促进血液循环：八段锦可以促进血液循环，并帮助身体更有效地输送氧气和营养物质。这有助于心血管健康，并有可能帮助预防某些心血管疾病，增强身体免疫力。
                </div>
                <div class="Ctext-middle">相关推荐</div>
                <div class="Ctext-middle-list">
...
.content-text .Ctext-middle-list {
    border-bottom: 1px solid #ccc;
    padding-bottom: 2vh;
    overflow-y: auto;
    height: 35vh;
...
.content-text .Ctext-middle-list::-webkit-scrollbar {
    display: none;
}
